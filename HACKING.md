...
hidden if the `libnikola_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `libnikola_DEVELOPER_MODE` to the configure
...
Python 3.6+
Python libs: python3-jinja2 python3-pygments
Doxygen
dvisvgm
